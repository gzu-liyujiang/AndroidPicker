package cn.qqtheme.framework.core;
...
import cn.qqtheme.framework.common.R;
...
public abstract class BasePopup<P extends BasePopup> implements PopupWindow.OnDismissListener,
    ...
    private int animationStyle = R.style.PopupAnimation;
    ...
    protected void onApplyAfter() {
    }

    protected final boolean isApply() {
        return isApply;
    }
    ...
    public void onAny(LifecycleOwner source, Lifecycle.Event event) {
        LogUtils.debug("lifecycle: " + event.name());
