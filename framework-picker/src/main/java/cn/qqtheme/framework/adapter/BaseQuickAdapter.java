 ...
 */
public abstract class BaseQuickAdapter<T, H extends AdapterHelper> extends BaseAdapter {
     ...
     */
    public BaseQuickAdapter(Context context, int layoutRes) {
     ...
     */
    public BaseQuickAdapter(Context context, int layoutRes, List<T> data) {
    ...
    public void replaceAll(ArrayList<T> elem) {
        data.clear();
        data.addAll(elem);
        notifyDataSetChanged();
    }
