...
import com.github.gzuliyujiang.basepicker.StateDrawable;
...
public class FileAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public FileAdapter(@NonNull Context context) {
        ...
        homeIcon = context.getDrawable(R.mipmap.file_picker_home);
        upIcon = context.getDrawable(R.mipmap.file_picker_up);
        folderIcon = context.getDrawable(R.mipmap.file_picker_folder);
        fileIcon = context.getDrawable(R.mipmap.file_picker_file);
    }
