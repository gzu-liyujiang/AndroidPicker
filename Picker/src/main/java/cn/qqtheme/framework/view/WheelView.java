...
public class WheelView extends ScrollView {
    public static final int FOCUS_COLOR = 0xFF0288ce;
    public static final int NORMAL_COLOR = 0xFFbbbbbb;
...
//            position = divided + offset + 1;
        ...
        for (int i = 0; i < childSize; i++) {
            ...
            if (position == i) {
                itemView.setTextColor(FOCUS_COLOR);
            } else {
                itemView.setTextColor(NORMAL_COLOR);
            }
        }
    }
